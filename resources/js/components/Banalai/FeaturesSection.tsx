    ...
    return (
        <section className="mt-4 bg-white px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-7xl">
                <p className="mb-4 font-semibold text-gray-900">One search. Unlimited knowledge.</p>
                <div className="grid grid-cols-2 gap-2 md:grid-cols-3 lg:grid-cols-6 xl:grid-cols-8">
                    {features?.map((item, index) => (
                        ...
                        >
                            ...
                            <h3 className="mb-2 line-clamp-3 text-center text-xs font-semibold text-gray-900">{item?.name}</h3>
                        </a>
                    ))}
                </div>
